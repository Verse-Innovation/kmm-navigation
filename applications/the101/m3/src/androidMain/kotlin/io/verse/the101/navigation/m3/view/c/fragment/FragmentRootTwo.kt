...
class FragmentRootTwo : DestinationFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.destination_cta).apply {
            text = "Go to FragmentWithChildren"
            setOnClickListener {
                (requireActivity() as DestinationActivity).navigateInternal(
                    listOf(FragmentWithChildren::class.java)
                )
            }
        }
    }
    ...
    companion object {
        ...
        const val MY_PATH = "/fragmentRootTwo"
    }
}